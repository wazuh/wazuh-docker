...
| Issue | Comment |
| - | - |
| [#6124](https://github.com/wazuh/internal-devel-requests/issues/6124) | Enable strict TLS hostname verification by default between the dashboard and the indexer |
