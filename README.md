...
Containers are currently tested on Wazuh version 3.5.0 and Elastic Stack version 6.3.2. We will do our best to keep this repository updated to latest versions of both Wazuh and Elastic Stack.
