...
* `Wazuh.Version_ElasticStack.Version` (for example 3.9.4_6.8.2) branch. This branch contains the current release referenced in Docker Hub. The container images are installed under the current version of this branch.
