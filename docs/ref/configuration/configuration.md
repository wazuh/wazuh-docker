...
This section details how to configure your Wazuh-Docker deployment (version 5.2.0). Proper configuration is key to tailoring the Wazuh stack to your specific needs, managing data persistence, and integrating with your environment.
