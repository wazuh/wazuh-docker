...
Welcome to the Reference Manual for Wazuh-Docker, version 4.14.9. This manual provides comprehensive information about deploying, configuring, and managing your Wazuh environment using Docker.
...
This manual refers to version 4.14.9 of Wazuh-Docker. Ensure you are using the documentation that corresponds to your deployed version.
