...
3.  Download the certificate creation script and config.yml file:
    ...
    ```bash
    curl -o wazuh-certs-tool.sh https://packages.wazuh.com/5.0/wazuh-certs-tool-10.9.9-1.sh
    curl -o config.yml https://packages.wazuh.com/5.0/config-10.9.9-1.yml
    ```
