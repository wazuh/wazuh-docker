...
Usage: build-images.sh [OPTIONS]
    ...
    -d, --dev <ref>              [Optional] Set the development stage you want to build, example rc2 or alpha0, not used by default.
    ...
    -v, --version <ver>          [Optional] Set the Wazuh version should be builded. By default, 10.9.9.
