...
This section outlines the steps required to set up your local development environment for working with the Wazuh-Docker project (version 5.2.0). A proper setup is crucial for building images, running tests, and contributing effectively.
...
1.  **Clone the Repository**:
    Clone the `wazuh-docker` repository from GitHub. It's important to check out the specific branch you intend to work with, in this case, `5.2.0`.
