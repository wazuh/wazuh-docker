...
build() {
    ...
    # WAZUH_MINOR_VERSION: Extracts major and minor version only (e.g., 5.2.0 -> 5.0)
    WAZUH_MINOR_VERSION="${WAZUH_IMAGE_VERSION%.*}"
    # WAZUH_MAJOR_VERSION: Extracts major version only (e.g., 5.2.0 -> 5)
